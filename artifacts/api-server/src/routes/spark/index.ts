...
// AI generation routes (POST for creation, GET for data fetching)
...
sparkRouter.post("/spark/generate-winning-products", generateWinningProductsHandler);
...
// GET aliases for data fetching routes (matching frontend custom-hooks paths)
sparkRouter.get("/spark/generate-trending", generateTrendingHandler);
sparkRouter.get("/spark/generate-winning-products", generateWinningProductsHandler);
